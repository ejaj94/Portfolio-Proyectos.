...
const DECORATIVE_NAMES = [
    ...
    { pt: "Caixa de Alianças", es: "Caja de Alianzas", en: "Wedding Ring Box", fr: "Boîte à Alliances", basePrice: 7.90 },
...
for (let i = 1; i <= 39; i++) {
    ...
    PRODUCTS.push({
        ...
        qty: 1,
        pt: {
            name: nameTemplate.pt.includes("Placa Decorativa") || nameTemplate.pt.includes("Caixa de Alianças") ? "Caixa de alianças em madeira com decoração especial para essa ocasião especial." : nameTemplate.pt === "Placa Decorativa" ? "Placa com dedicatória com boneca em gesso a dedicatória pode ser personalizada ao gosto do cliente." : nameTemplate.pt.includes("Conjunto Pureza") || nameTemplate.pt.includes("Peça Decorativa com Íman") ? nameTemplate.pt : `${nameTemplate.pt} #${i}`,
            categoryLabel: "Peça Decorativa",
            aromaBrief: "Design minimalista e elegante em gesso ecológico com acabamento impermeabilizado.",
            description: nameTemplate.pt === "Placa Decorativa com Dedicatória" ? "Placa com dedicatória com qualquer mensagem que deseje, pode escolher-se as cores e modelos ao gosto dessa pessoa especial que queira agradar esse dia." : nameTemplate.pt.includes("Caixa de Alianças") ? "Caixa de alianças em madeira com decoração especial para essa ocasião especial." : nameTemplate.pt === "Placa Decorativa" ? "Placa com dedicatória com boneca em gesso a dedicatória pode ser personalizada ao gosto do cliente." : nameTemplate.pt.includes("Conjunto Pureza") ? "Peças decorativas em jesmonite que oferecem elegância e simplicidade a qualquer espaço. Pode também alterar as cores, flores e decoração ao seu gosto." : nameTemplate.pt.includes("Peça Decorativa com Íman") ? "Peça decorativa com adaptador para folhas para facilitar apontamentos, lista de compras, tarefas ou qualquer uso, isso fica à sua imaginação. Tem a opção de poder escolher o nome da pessoa que deseja oferecer ou para si." :  "Uma peça decorativa exclusiva feita à mão em gesso ecológico premium, com acabamento impermeável acetinado. Perfeita para organizar joias, perfumes, sabonetes ou como base para as nossas velas aromáticas. Cada peça é única e moldada individualmente em Portugal.",
