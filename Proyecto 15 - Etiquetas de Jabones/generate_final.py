...
data = [
    ...
    {"title": "Carvão", "drawing": "drawing_carvao*.png", "ingredientes": "Glicerina 100% vegetal, carvão ativo, àgua e sumo de limão.", "esteticos": "Controla a oleosidade da pele, limpeza dos poros, clareador de manchas.", "espiritual": "Ajuda a eliminar energias negativas."},
    {"title": "Anis e mel", "drawing": "drawing_anis_mel*.png", "ingredientes": "Glicerina 100% vegetal, àgua, mel, anis estrelado e canela em pó, essência de mel e canela.", "esteticos": "Estimula a produção de colágeno, renovação celular, ajuda a deixar a pele mais firme. Ajuda na acne, dermatite e eczemas. hidrata profundamente, combate a acne, previne o envelhecimento precoce e promove a cicatrização de pequenas irritações na pele", "espiritual": "O Anis ajuda na abertura da mediunidade. O mel ajuda harmonia e a atração de energias positivas."},
    {"title": "Aveia & Amêndoa", "drawing": "drawing_aveia_amendoa*.png", "ingredientes": "Glicerina 100% vegetal, essência natural de aveia e mel, mel, amêndoa e flocos de aveia e óleo de amêndoas doces.", "esteticos": "A amêndoa e a aveia são ricos em propriedades estéticas complementares ideais para nutrir, proteger e rejuvenescer a pele. Enquanto o óleo de amêndoa atua na hidratação e luminosidade, a aveia foca na regeneração celular, firmeza e suavidade.", "espiritual": "Elas nutrem o corpo físico para promover a clareza mental, o equilíbrio emocional e a elevação da vibração energética."}
]
...
try:
    font_title = ImageFont.truetype("georgiai.ttf", 85)
    font_bold = ImageFont.truetype("segoeuib.ttf", 36)
    font_body = ImageFont.truetype("segoeuib.ttf", 30)
except:
...
for i, item in enumerate(data):
    ...
    if matches:
        ...
        try:
            ...
            drawing_img.thumbnail((380, 380), Image.Resampling.LANCZOS)
            ...
            current_y += drawing_img.height + 12
        except Exception as e:
