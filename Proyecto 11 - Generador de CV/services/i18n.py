...
_CATALOGUE: Dict[str, Dict[str, str]] = {
    ...
    "en": {
        ...
        "edu_heading":         "Degrees & Education",
        "cert_heading":        "Certifications",
        "exp_title":           "Role / Position",
        "exp_company":         "Company",
        "exp_dates":           "Dates",
        "exp_desc":            "Description",
        "edu_degree":          "Degree / Course",
        ...
        "skill_cat_ph":        "Category",
        "skill_items_ph":      "Python, SQL, etc.",
        "date_current":        "Current job",
        "date_current_edu":    "Still studying here",
        "btn_save":            "Save",
        "btn_cancel":          "Cancel",
        "months":              "Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec",
        "days":                "Mo,Tu,We,Th,Fr,Sa,Su",
        "lang_options":        "English,Spanish,French,German,Portuguese,Italian,Chinese,Japanese,Russian",
        "lang_levels":         "Basic,Intermediate,Advanced,Native/Bilingual",
    ...
    "es": {
        ...
        "add_edu":             "+ Añadir Curso",
        "add_lang":            "+ Añadir Idioma",
        "edu_heading":         "Educación y Títulos",
        "cert_heading":        "Certificados",
        "exp_title":           "Cargo / Puesto",
        "exp_company":         "Empresa",
        "exp_dates":           "Fechas",
        "exp_desc":            "Descripción",
        "edu_degree":          "Título / Curso",
        "edu_school":          "Institución",
        "edu_dates":           "Fechas",
        "remove":              "- Eliminar",
        "date_from":           "Desde",
        "date_to":             "Hasta",
        "date_current":        "Actualidad",
        "months":              "Ene,Feb,Mar,Abr,May,Jun,Jul,Ago,Sep,Oct,Nov,Dic",
        "days":                "Lu,Ma,Mi,Ju,Vi,Sa,Do",
        "skill_cat_ph":        "Categoría",
        "skill_items_ph":      "Python, SQL, etc.",
        "date_current":        "Actualmente trabajo allí",
        "date_current_edu":    "Aún estudio aquí",
        "btn_save":            "Guardar",
        "btn_cancel":          "Cancelar",
        "months":              "Ene,Feb,Mar,Abr,May,Jun,Jul,Ago,Sep,Oct,Nov,Dic",
        "days":                "Lu,Ma,Mi,Ju,Vi,Sa,Do",
        "lang_options":        "Español,Inglés,Francés,Alemán,Portugués,Italiano,Chino,Japonés,Ruso",
        "lang_levels":         "Básico,Medio,Avanzado,Profesional/Nativo",
    ...
    "pt": {
        ...
        "add_edu":             "+ Adicionar Formação",
        "add_lang":            "+ Adicionar Idioma",
        "edu_heading":         "Educação e Graus",
        "cert_heading":        "Certificados",
        "exp_title":           "Cargo / Posição",
        "exp_company":         "Empresa",
        "exp_dates":           "Datas",
        "exp_desc":            "Descrição",
        "edu_degree":          "Curso",
        "edu_school":          "Instituição",
        "edu_dates":           "Datas",
        "remove":              "- Remover",
        "date_from":           "De",
        "date_to":             "Até",
        "date_current":        "Atualmente",
        "months":              "Jan,Fev,Mar,Abr,Mai,Jun,Jul,Ago,Set,Out,Nov,Dez",
        "days":                "Se,Te,Qu,Qu,Se,Sa,Do",
        "skill_cat_ph":        "Categoria",
        "skill_items_ph":      "Python, SQL, etc.",
        "date_current":        "Trabalho atualmente aqui",
        "date_current_edu":    "Ainda estudo aqui",
        "btn_save":            "Guardar",
        "btn_cancel":          "Cancelar",
        "months":              "Jan,Fev,Mar,Abr,Mai,Jun,Jul,Ago,Set,Out,Nov,Dez",
        "days":                "Se,Te,Qa,Qi,Se,Sa,Do",
        "lang_options":        "Espanhol,Inglês,Francês,Alemão,Português,Italiano,Chinês,Japonês,Russo",
        "lang_levels":         "Básico,Intermediário,Avançado,Nativo/Fluente",
